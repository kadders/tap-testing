...
def milling_stability_lobes_nutshell() -> str:
    ...
    return (
        ...
        "system is time-invariant. The limiting chip width is blim = −1/(2·Ks·Re[FRF_orient]·Nt*) (valid when Re < 0), "
...
def milling_process_damping_stability_nutshell() -> str:
    ...
    return (
        ...
        "Limiting chip width blim = −1/(2·Ks·Re[FRF_orient]·Nt*) (Eq. 4.109; Re < 0); fc/(Ω·Nt) = N + ε/(2π) "
